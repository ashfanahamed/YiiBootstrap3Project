...
class BootstrapButtonColumn extends CButtonColumn
{
    ...
    public $updateButtonOptions = array('class'=>'btn btn-success btn-xs');

    public $viewButtonOptions = array('class'=>'btn btn-info btn-xs');

    public $deleteButtonOptions = array('class'=>'btn btn-danger btn-xs');
	...
	protected function renderButton($id, $button, $row, $data)
	{
		...
		{
			if (strpos($button['icon'], 'glyphicon glyphicon-') === false)
